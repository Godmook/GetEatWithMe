        ...
        search_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Query.matches(""))
                    ...
                    Call<ResultSearchKeyword> call = userProfileAPI.GetSearchKeyword("KakaoAK f9e3926b054ba1f5d08a2672f49e8869", Query, auto.getString("longitude", null), auto.getString("latitude", null), "1000");
                    try {
